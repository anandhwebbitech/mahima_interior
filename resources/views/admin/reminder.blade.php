...
@section('title', 'Reminder - Mahima Interior CRM')
...
<div class="container">
    ...
    <div class="page-banner d-flex justify-content-between align-items-center mb-3">
        <h5 class="m-0">
            <i class="fa-solid fa-user-clock me-2"></i> Reminder List
        </h5>
...
<script>
    $(document).ready(function() {
        ...
        $('#customerFilter, #from_date, #to_date').on('change input', function () {
            table.draw();
        });
